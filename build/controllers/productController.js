...
var updateProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, productData, fetchedProduct, validator, errs, product;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = parseInt(req.params.id);
            ...
            case 1:
                ...
                return [3 /*break*/, 4];
            case 2:
                validator = jsonschema_1.default.validate(productData, productUpdate_json_1.default);
                if (!validator.valid) {
                    errs = (0, jsonSchemaHelper_1.default)(validator.errors);
                    throw new expressError_1.BadRequestError(errs);
                }
                return [4 /*yield*/, ProductModel_1.default.updateProduct(productData, id)];
            case 3:
                product = (_a.sent()) || {
                    id: "not found",
                };
