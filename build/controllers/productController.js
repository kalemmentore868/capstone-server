...
var getSingleProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, ProductModel_1.default.findOne({ _id: id })];
            case 1:
                product = _a.sent();
                if (!product) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                product = new ProductModel_1.default(productData);
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                res.status(404).json({
                    message: "Product with id: ".concat(id, " cannt be found"),
                });
                return [3 /*break*/, 4];
            case 2:
                ...
                return [4 /*yield*/, ProductModel_1.default.findOneAndUpdate({ _id: id }, req.body, {
                        runValidators: true,
                        new: true,
                    })];
            case 3:
                product = (_a.sent()) || { id: "not found" };
                res.json({
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [3 /*break*/, 4];
            case 2: return [4 /*yield*/, ProductModel_1.default.deleteOne({ _id: id })];
            case 3:
                _a.sent();
                res.json({
