    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, UserModel_1.default.findOneAndUpdate({ _id: id }, userData, {
                        runValidators: true,
                        new: true,
                    })];
            case 3:
                user = (_a.sent()) || { id: "not found" };
                res.json({
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [3 /*break*/, 4];
            case 2: return [4 /*yield*/, UserModel_1.default.deleteOne({ _id: id })];
            case 3:
                _a.sent();
                res.json({
