...
var getOrders = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        OrderModel_1.default.find({ userId: userId })
            .sort({ date: -1 })
            .then(function (orders) { return res.json(orders); });
        return [2 /*return*/];
    });
}); };
exports.getOrders = getOrders;
var checkout = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, paymentData, newPayment, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                ...
                return [4 /*yield*/, PaymentModel_1.default.create(paymentData)];
            case 1:
                newPayment = _a.sent();
