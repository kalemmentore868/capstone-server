...
exports.checkout = exports.getOrders = void 0;
...
var getOrders = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, order, orderItems;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                userId = parseInt(req.params.id);
                return [4 /*yield*/, OrderModel_1.default.getOrderByUserId(userId)];
            case 1:
                order = _a.sent();
                ...
                return [3 /*break*/, 4];
            case 2: return [4 /*yield*/, OrderItemModel_1.default.getAllItemsFromOrder(order.id)];
            case 3:
                orderItems = _a.sent();
...
var checkout = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, notes, cart, user, email, cartItems, orderObj, order, i, cartItem, orderedItems, subject, text, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 10:
                ...
                text = "Thank you for your purchase! \n\n       items: ".concat(orderedItems, "\n       total: $").concat(order.total, "\n       Notes: ").concat(order.notes);
