    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 10:
                ...
                text = "\n\n      <!DOCTYPE html>\n<html>\n<head>\n  <title>Order Confirmation</title>\n  <style>\n    /* Add your custom CSS styles here */\n    body {\n      font-family: Arial, sans-serif;\n      margin: 0;\n      padding: 0;\n    }\n    .container {\n      max-width: 600px;\n      margin: 0 auto;\n      padding: 20px;\n      background-color: #f2f2f2;\n    }\n    .product {\n      display: flex;\n      margin-bottom: 20px;\n    }\n    .product img {\n      width: 100px;\n      height: auto;\n      margin-right: 10px;\n    }\n    .product-info {\n      flex-grow: 1;\n    }\n    .product-title {\n      font-weight: bold;\n      margin: 0;\n    }\n    .product-desc {\n      margin: 5px 0;\n    }\n    .product-price {\n      font-weight: bold;\n    }\n    .product-quantity {\n      margin-bottom: 10px;\n    }\n  </style>\n</head>\n<body>\n\n    <h2>Order Confirmation</h2>\n    <h3>Thank you for your order!</h3>\n     \n      <p>Order made by: ".concat(user.first_name, " ").concat(user.last_name, "</p>\n      <p>Address: ").concat(address.street, " ").concat(address.house_number, ", ").concat(address.city, "\n      \n      ").concat(orderedItems, "\n      \n      <p>Sub Total: ").concat(order.total, "</p>\n      <p>Shipping: $").concat(15, "</p>\n      <p>Total: ").concat((order.total + 15).toFixed(2), "</p>\n      \n      <p>Notes: ").concat(notes, "</p>\n      <p>Order made at: ").concat(order.created_at, "\n\n      </div>\n</body>\n</html>\n      ");
