...
exports.getOrdersAsString = void 0;
...
var getOrdersAsString = function (orderId) { return __awaiter(void 0, void 0, void 0, function () {
    var orderedItems, email, i, item, product;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, OrderItemModel_1.default.getAllItemsFromOrder(orderId)];
            case 1:
                ...
                _a.label = 2;
            case 2:
                if (!(i < orderedItems.length)) return [3 /*break*/, 5];
                item = orderedItems[i];
...
exports.getOrdersAsString = getOrdersAsString;
